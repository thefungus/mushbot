...
function load(mb, cb) {
    let characters = {
        "banjo_and_kazooie": [
            "banjo", "banjo kazooie", "banjo & kazooie", "banjo and kazooie"
        ],
        "bayonetta": [
        ...
        "mr_game_and_watch": [
            ...
            "gameandwatch", "gw", "gaw", "mr. game & watch"
        ],
        "mythra": [
            "mythra"
        ],
...
let commands = {
    kuroganehammer: {
        names: ["kuroganehammer", "kurogane", "kh", "ufd", "framedata"],
        allowPrivate: true,
        perms: [],
        userCd: 10,
...
function help() {
    return util.dedent`__Ultimate Frame Data Plugin__
